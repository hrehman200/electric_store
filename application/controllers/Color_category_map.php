...
class Color_category_map extends CI_Controller{
    ...
    {   
        ...
        $data['color_category_map'] = $this->Color_category_map_model->get_color_category_map($);
        ...
        if(isset($data['color_category_map']['']))
        {
            ...
            {   
                ...
                $this->Color_category_map_model->update_color_category_map($,$params);            
                redirect('color_category_map/index');
            }
            else
            {
    ...
    function remove($)
    {
        $color_category_map = $this->Color_category_map_model->get_color_category_map($);

        // check if the color_category_map exists before trying to delete it
        if(isset($color_category_map['']))
        {
            $this->Color_category_map_model->delete_color_category_map($);
            redirect('color_category_map/index');
        }
        else
